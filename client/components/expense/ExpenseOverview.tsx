...
import { currentMonthPreview, getExpensesByCategory } from '../../api/ExpenseAPI';
                        ...
                        <div key={index} style={{ display: 'grid', justifyContent: 'center' }}>
                            ...
                            <div style={{ marginBottom: 3 }}>
                                ...
                                <Typography
                                    component="span"
                                    className={classes.val}
                                    style={{ color: '#002f6c', fontSize: '1.6em', backgroundColor: '#eafff5', padding: '8px 0' }}>
                                ...
                                <Typography
                                    ...
                                    ${expense.mergedValues.total ? Math.abs(expense.mergedValues.total - expense.mergedValues.average) : expense.mergedValues.average}
                                </Typography>
                            </div>
